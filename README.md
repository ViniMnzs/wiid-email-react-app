<ul>
    ...
    <li>Open your terminal and write command: "yarn"</li>
    <li>After dependencies installed, write on terminal "yarn start"</li>
    <li>Do login with user:admin, pass:admin</li>
    </br>
